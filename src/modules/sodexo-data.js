...
const parseSodexoMenu = (sodexoDailyMenu) => {
  ...
  for (const course of courses) {
    coursesEn.push(`${course.title_en} (${course.dietcodes ? course.dietcodes + ', ' : ''}${course.additionalDietInfo ? course.additionalDietInfo.allergens : 'No allergens'}) ${course.price}`);
    coursesFi.push(`${course.title_fi} (${course.dietcodes ? course.dietcodes + ', ' : ''}${course.additionalDietInfo ? course.additionalDietInfo.allergens : 'Ei allergeenejä'}) ${course.price}`);
  }
